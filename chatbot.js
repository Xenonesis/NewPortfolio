document.addEventListener('DOMContentLoaded', () => {
 ...
 careeradvice: 'If you need career advice, I'm here to help 🤔 Just let me know what you're looking for.',
  laravel: 'I love working with Laravel! 🚀 It's an amazing PHP framework that makes web development so much easier and more enjoyable.',
  php: 'PHP is a powerful server-side language 💪 I use it daily in my work at Prarang for building robust web applications.',
  prarang: 'I work at Prarang as a Laravel Developer 🏢 It's a great company where I get to work on exciting web development projects!',
  job: 'I currently work as a Laravel Developer at Prarang 💼 I love building web applications and working with PHP frameworks!',
  company: 'Prarang is an amazing company to work for! 🌟 I'm grateful to be part of such a innovative team.',
